...
libsdirs=' /lib/i386-linux-gnu'
libsfiles=' libgdbm.so libgdbm_compat.so libdb.so libdl.so libm.so libpthread.so libc.so libcrypt.so'
libsfound=' /lib/i386-linux-gnu/libgdbm.so /lib/i386-linux-gnu/libgdbm_compat.so /lib/i386-linux-gnu/libdb.so /lib/i386-linux-gnu/libdl.so /lib/i386-linux-gnu/libm.so /lib/i386-linux-gnu/libpthread.so /lib/i386-linux-gnu/libc.so /lib/i386-linux-gnu/libcrypt.so'
libspath=' /usr/local/lib /usr/lib/gcc/i686-linux-gnu/8/include-fixed /usr/include/i386-linux-gnu /usr/lib /lib/i386-linux-gnu /lib/../lib /usr/lib/i386-linux-gnu /usr/lib/../lib /lib /lib64 /usr/lib64'
